package com.example.util_biometric;
 ...
 * UtilBiometricPlugin
 */
public class UtilBiometricPlugin implements FlutterPlugin, MethodCallHandler {
    ...
    public void onAttachedToEngine(@NonNull FlutterPluginBinding flutterPluginBinding) {
        channel = new MethodChannel(flutterPluginBinding.getBinaryMessenger(), "util_biometric");
    ...
    public void onMethodCall(@NonNull MethodCall call, @NonNull Result result) {
        ...
        } else if (call.method.equals("isInvalidateBiometrics")) {
